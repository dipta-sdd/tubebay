...
class Settings
{
	...
	public function update_settings($key_or_data, $val = '')
	{
		...
		update_option(TUBEBAY_OPTION_NAME, $options);
		$this->load_settings();
	}
	...
	public function get_settings_schema()
	{
		 ...
		 *
		 * @since 1.0.0
		 * @hook tubebay_options_properties
	...
	public function sanitize_settings_object($input)
	{
		...
		$sanitized_output = get_option(TUBEBAY_OPTION_NAME, $default_options);
