...
![Sync Library Button](file:///docs/public/img/library-sync-button.png)

3. Wait for the process to complete. You will see a notification once the new videos are cached.

![Sync Progress and Success](file:///docs/public/img/library-sync-progress.png)

## Sync Status
You can monitor the sync status in the **TubeBay Dashboard**.

![Dashboard Sync Status](file:///docs/public/img/dashboard-sync-status.png)
...
![Sync Error State](file:///docs/public/img/library-sync-error.png)
